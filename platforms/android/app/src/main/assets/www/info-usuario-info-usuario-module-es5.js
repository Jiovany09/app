(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["info-usuario-info-usuario-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppInfoUsuarioInfoUsuarioPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppInfoUsuarioInfoUsuarioRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "InfoUsuarioPageRoutingModule", function () {
        return InfoUsuarioPageRoutingModule;
      });
      /* harmony import */
      ...
      var _info_usuario_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./info-usuario.page */
      ...
      var InfoUsuarioPageRoutingModule = function InfoUsuarioPageRoutingModule() {
        _classCallCheck(this, InfoUsuarioPageRoutingModule);
      };

      InfoUsuarioPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppInfoUsuarioInfoUsuarioModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "InfoUsuarioPageModule", function () {
      ...
      var _info_usuario_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./info-usuario-routing.module */
      "./src/app/info-usuario/info-usuario-routing.module.ts");
      /* harmony import */


      var _info_usuario_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./info-usuario.page */
      "./src/app/info-usuario/info-usuario.page.ts");

      var InfoUsuarioPageModule = function InfoUsuarioPageModule() {
        _classCallCheck(this, InfoUsuarioPageModule);
      };

      InfoUsuarioPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _info_usuario_routing_module__WEBPACK_IMPORTED_MODULE_5__["InfoUsuarioPageRoutingModule"]],
    ...
    /***/
    function srcAppInfoUsuarioInfoUsuarioPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppInfoUsuarioInfoUsuarioPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "InfoUsuarioPage", function () {
      ...
      var InfoUsuarioPage = /*#__PURE__*/function () {
        function InfoUsuarioPage(_route, _router, _userService, alertCtrl) {
          _classCallCheck(this, InfoUsuarioPage);
        ...
        _createClass(InfoUsuarioPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {} // async showAlert() {
          ...
          value: function onSubmit(form) {
            ...
            this._userService.update(this.identity.sub, this.user).subscribe(function (response) {
              if (response.data.status == 'success') {
                ...
                Toast.fire({
                  icon: 'success',
                  title: 'Usuario ' + _this.identity.nombre + ' editado correctamente'
                }); // Redirect

                localStorage.setItem('identity', JSON.stringify(_this.identity));

                _this._router.navigate(['/conf-usuario']);
              } else {
                var _Toast = sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.mixin({
                  toast: true,
                  position: 'top-end',
                  showConfirmButton: false,
                  timer: 3000,
                ...
                _Toast.fire({
                  icon: 'error',
                  title: 'Usuario ' + _this.identity.nombre + ' no editado correctamente'
                });
              }
            }, function (error) {
              console.log(error);
      ...
      InfoUsuarioPage.ctorParameters = function () {
        return [{
      ...
      InfoUsuarioPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-info-usuario',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./info-usuario.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/info-usuario/info-usuario.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./info-usuario.page.scss */
        "./src/app/info-usuario/info-usuario.page.scss"))["default"]]
      })], InfoUsuarioPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=info-usuario-info-usuario-module-es5.js.map
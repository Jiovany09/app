...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | detalle-contenedor-detalle-contenedor-module */ "common").then(__webpack_require__.bind(null, /*! ./detalle-contenedor/detalle-contenedor.module */ "./src/app/detalle-contenedor/detalle-contenedor.module.ts")).then(m => m.DetalleContenedorPageModule), canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
    {
        path: 'agregar-usuario',
        loadChildren: () => __webpack_require__.e(/*! import() | agregar-usuario-agregar-usuario-module */ "agregar-usuario-agregar-usuario-module").then(__webpack_require__.bind(null, /*! ./agregar-usuario/agregar-usuario.module */ "./src/app/agregar-usuario/agregar-usuario.module.ts")).then(m => m.AgregarUsuarioPageModule), canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
    {
        path: 'agregar-contenedor',
        loadChildren: () => __webpack_require__.e(/*! import() | agregar-contenedor-agregar-contenedor-module */ "agregar-contenedor-agregar-contenedor-module").then(__webpack_require__.bind(null, /*! ./agregar-contenedor/agregar-contenedor.module */ "./src/app/agregar-contenedor/agregar-contenedor.module.ts")).then(m => m.AgregarContenedorPageModule), canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
    {
        path: 'login',
    ...
    {
        path: 'registrar',
        loadChildren: () => Promise.all(/*! import() | registrar-registrar-module */[__webpack_require__.e("common"), __webpack_require__.e("registrar-registrar-module")]).then(__webpack_require__.bind(null, /*! ./registrar/registrar.module */ "./src/app/registrar/registrar.module.ts")).then(m => m.RegistrarPageModule)
    },
    {
        path: 'info-usuario',
        loadChildren: () => Promise.all(/*! import() | info-usuario-info-usuario-module */[__webpack_require__.e("default~conf-usuario-conf-usuario-module~info-usuario-info-usuario-module"), __webpack_require__.e("info-usuario-info-usuario-module")]).then(__webpack_require__.bind(null, /*! ./info-usuario/info-usuario.module */ "./src/app/info-usuario/info-usuario.module.ts")).then(m => m.InfoUsuarioPageModule), canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
    {
        path: 'conf-usuario',
        loadChildren: () => Promise.all(/*! import() | conf-usuario-conf-usuario-module */[__webpack_require__.e("default~conf-usuario-conf-usuario-module~info-usuario-info-usuario-module"), __webpack_require__.e("conf-usuario-conf-usuario-module")]).then(__webpack_require__.bind(null, /*! ./conf-usuario/conf-usuario.module */ "./src/app/conf-usuario/conf-usuario.module.ts")).then(m => m.ConfUsuarioPageModule), canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
    {
        path: 'agregar-lampara',
        loadChildren: () => __webpack_require__.e(/*! import() | agregar-lampara-agregar-lampara-module */ "agregar-lampara-agregar-lampara-module").then(__webpack_require__.bind(null, /*! ./agregar-lampara/agregar-lampara.module */ "./src/app/agregar-lampara/agregar-lampara.module.ts")).then(m => m.AgregarLamparaPageModule), canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
    {
        path: 'modal-lampara',
        loadChildren: () => Promise.all(/*! import() | modal-lampara-modal-lampara-module */[__webpack_require__.e("common"), __webpack_require__.e("modal-lampara-modal-lampara-module")]).then(__webpack_require__.bind(null, /*! ./modal-lampara/modal-lampara.module */ "./src/app/modal-lampara/modal-lampara.module.ts")).then(m => m.ModalLamparaPageModule), canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
    {
        path: 'error404',
        loadChildren: () => __webpack_require__.e(/*! import() | error404-error404-module */ "error404-error404-module").then(__webpack_require__.bind(null, /*! ./error404/error404.module */ "./src/app/error404/error404.module.ts")).then(m => m.Error404PageModule)
    },
    {
        path: '**',
        redirectTo: '/error404',
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FiltroContenedorPipe", function() { return FiltroContenedorPipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


let FiltroContenedorPipe = class FiltroContenedorPipe {
...
FiltroContenedorPipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
let FiltroPipe = class FiltroPipe {
    transform(arreglo, texto) {
        ...
        texto = texto.toLowerCase();
        return arreglo.filter(item => {
            return item.lampara.toLowerCase()
                .includes(texto);
        });
    }
};
...
/* harmony import */ var _filtro_contenedor_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filtro-contenedor.pipe */ "./src/app/pipes/filtro-contenedor.pipe.ts");
...
module.exports = __webpack_require__(/*! C:\Users\guapo\Desktop\PROYECTOS\App WEB Y MOVIL\MOVIL-Actual-GitLab\beta-movil\src\main.ts */"./src/main.ts");
